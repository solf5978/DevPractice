...
func (c *Client) String() string {
	return fmt.Sprintf("ConsulIP: %s , Connection String: %s", c.connString, c.consulIP)
}
...
//	FromFile func returns the ConfigFunc type.
//	So this way it could read the configuration from the json.
...
//	FromEnv reads the configuration from the environmental variables
