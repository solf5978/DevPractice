...
func main() {
	...
	//	The formatting is done with use of reference value Jan 2 15:04:05 2006 MST
	...
	//	The formatting supports space padding only for days in Go Ver. 1.9.2
	fmt.Printf("tTime is : %s\n", tTime.Format("2006/1/_2"))

	//	The zero padding is done by adding 0
	fmt.Printf("tTime is : %s\n", tTime.Format("2006/02/01"))
	...
	fmt.Println(string(tTime.AppendFormat(
		[]byte("The time is up: "), "03:04PM")))
}
